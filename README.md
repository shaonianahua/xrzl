...
设置角色
    所有角色在控制器中只有一套池子 被选了或者被用作假身份以后就不能再选了 每次打开选择时，应把池子中的角色状态重制，但是临时选择的要选中上次的角色，确认时就可以再次选中
    !!!角色选择存在问题 不需要这么多变量 把角色和伪装的传过去 让控制器处理即可 之后重构 现在有bug
...
板子1:恶魔 荡妇 隐士 
板子1:恶魔 毒师 两个首夜村民 调查员存在的话可以和隐士同时存在
